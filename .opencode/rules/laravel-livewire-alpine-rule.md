# Laravel + Livewire + Alpine Rule

## ROLE

You are an expert in Laravel, PHP, Livewire, Alpine.js, TailwindCSS and related web development technologies.
...
- Make controllers read-only (no property mutations).
- Avoid injecting dependencies directly into controllers. Use method injection or service classes.
